...
global.sudo = process.env.SUDO || "923477505897";
global.owner = process.env.OWNER_NUMBER || "923477505897";
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || "HASNAIN-𝐌𝐃-𝐕2",
  ownername: process.env.OWNER_NAME || "Hasnain",
  errorChat: process.env.ERROR_CHAT || "923477505897",
